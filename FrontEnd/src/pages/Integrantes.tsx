      ...
      <div className="max-w-3xl mx-auto px-5 py-12">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-6">
          {mockIntegrantes.map((p) => (
            <div
              key={p.rm}
              className="bg-surface border border-border rounded-xl p-5 hover:border-accent/30 hover:shadow-sm transition-all"
            >
              <img
                src={p.foto}
                alt={p.nome}
                className="w-16 h-16 rounded-full mb-4 border-2 border-border object-cover object-top"
              />
        ...
        <div className="bg-surface border border-border rounded-xl p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            ...
            <a
              href="https://youtu.be/prsl2J08fCo"
              target="_blank"
              rel="noreferrer"
              target="_blank"
              rel="noreferrer"
